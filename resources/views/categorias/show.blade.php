...
@section('cuerpo')
    <section class="media tm-highlight tm-highlight-w-icon mt-3">
        ...
        <div class="media-body">
            <header>
                <h2>Libros en la categoria: <button type="button" class="btn btn-success">{{ $categorie->name }}</button></h2>
            </header>
            <p class="tm-margin-b">
                <ol>
                    @if (count($books)==0)
            ...
            <a href="javascript:void(0);" onclick="window.history.back();" class="tm-white-bordered-btn">Regresar</a>
        </div>                    
    </section>
@stop