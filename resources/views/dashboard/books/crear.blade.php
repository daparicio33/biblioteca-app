        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    @endphp
                    {!! Form::label('programas', 'Programa de Estudios', ['class'=>'mt-2']) !!}
                    <x-adminlte-select2 id="programas" name="programas[]" label-class="text-danger" igroup-size="sm" :config="$config" multiple>
